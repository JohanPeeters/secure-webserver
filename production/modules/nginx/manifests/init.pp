...
#	$cipher_string = "ALL:$always_encrypted:$always_authenticated:$not_DES:$enc_key_at_least_128b:$impervious_to_BEAST:$not_RC4:$forward_secrecy:$impervious_to_Lucky_13_no_CBC:$compatability"
#	$cipher_string = "ALL"
