...
#	$cipher_string = "ALL:$always_encrypted:$always_authenticated:$not_DES:$enc_key_at_least_128b:$no_RSA_key_exchange_for_forward_secrecy:$impervious_to_Lucky_13_no_CBC"
